...
/**
 * Represents a Base32 encoding. <br />
 * Default constructor will create a standard Base32 encoding(RFC 4648).
 */
public class Base32Encoding extends BaseEncoding {

    /**
     * Standard Alphabet.
     */
    public static final String STANDARD_ALPHABET = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
    /**
     * Standard Padding.
     */
     ...
     */
    public static final String DEFAULT_NAME = "Standard Base32 Encoding";

    private final char[] alphabet;
    private final char padding;
    private final String encodingName;
    private final Base32 b;
     ...
     */
    public Base32Encoding(char[] alphabet, char padding) {
        this(alphabet, padding, "Customized Base32 Encoding", true);
    }

    /**
     * Initializes a new instance of the Base32Encoding class. Parameters specify the alphabet and the padding character and the name of encoding.
     *
     * @param alphabet     Alphabet for current encoding.
     * @param padding      Padding character for current encoding.
     ...
     * @throws IllegalArgumentException Arguments error, see the source code.
     */
    public Base32Encoding(char[] alphabet, char padding, String encodingName) {
        this(alphabet, padding, encodingName, true);
    }

    Base32Encoding(char[] alphabet, char padding, String encodingName, boolean verify) {
        if (verify) {
            if (alphabet == null)
            ...
            if (alphabet.length != 32)
                throw new IllegalArgumentException("size of alphabet is not 32");
        ...
        this.b = new Base32(this.alphabet, this.padding);
    }
